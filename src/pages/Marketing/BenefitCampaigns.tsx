...
const TRIGGER_OPTIONS: { value: BenefitCampaignTrigger; label: string; description: string }[] = [
  ...
  { value: 'referral', label: '회원그룹 발급', description: '회원 그룹 선택 후 일괄 발급' },
...
export function BenefitCampaigns() {
  ...
  const handleSelectCampaign = (campaign: BenefitCampaign) => {
    ...
    setFormData({
      ...
      referralBenefitTarget: campaign.referralCondition?.benefitTarget ?? 'both',
      referralMaxPerMember: campaign.referralCondition?.maxReferralsPerMember ?? null,
      manualIssueTargetType: campaign.referralCondition?.manualIssueTargetType ?? 'groups',
      manualIssueMemberIds: campaign.referralCondition?.manualIssueMemberIds ?? [],
      manualIssueGroupIds: campaign.referralCondition?.manualIssueGroupIds ?? [],
      manualIssueGradeIds: campaign.referralCondition?.manualIssueGradeIds ?? [],
