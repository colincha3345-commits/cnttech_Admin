...
export const FranchiseStaff: React.FC = () => {
  ...
  const resendInvitation = useResendFranchiseInvitation();
  const cancelInvitation = useCancelFranchiseInvitation();
          ...
          <table className="data-table w-full min-w-[900px]">
            <thead>
              <tr>
                ...
                <SortableHeader label="소속 가맹점" sortKey="storeId" currentSortKey={sortKey} currentSortOrder={sortOrder} onSort={handleSort} className="whitespace-nowrap" />
